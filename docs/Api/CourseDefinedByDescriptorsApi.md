...
| [**getCourseDefinedByDescriptorsPartitions()**](CourseDefinedByDescriptorsApi.md#getCourseDefinedByDescriptorsPartitions) | **GET** /ed-fi/courseDefinedByDescriptors/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing. |
...
```php
deleteCourseDefinedByDescriptorById($id, $if_match)
```
...
try {
    $apiInstance->deleteCourseDefinedByDescriptorById($id, $if_match);
} catch (Exception $e) {
    echo 'Exception when calling CourseDefinedByDescriptorsApi->deleteCourseDefinedByDescriptorById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->deletesCourseDefinedByDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CourseDefinedByDescriptorsApi->deletesCourseDefinedByDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCourseDefinedByDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\EdFiCourseDefinedByDescriptor[]
```
...
try {
    $result = $apiInstance->getCourseDefinedByDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CourseDefinedByDescriptorsApi->getCourseDefinedByDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->getCourseDefinedByDescriptorsById($id, $if_none_match, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CourseDefinedByDescriptorsApi->getCourseDefinedByDescriptorsById: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getCourseDefinedByDescriptorsPartitions()`

```php
getCourseDefinedByDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\GetAbsenceEventCategoryDescriptorsPartitions200Response
```
...
try {
    $result = $apiInstance->getCourseDefinedByDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CourseDefinedByDescriptorsApi->getCourseDefinedByDescriptorsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->keyChangesCourseDefinedByDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CourseDefinedByDescriptorsApi->keyChangesCourseDefinedByDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
postCourseDefinedByDescriptor($ed_fi_course_defined_by_descriptor)
```
...
try {
    ...
    echo 'Exception when calling CourseDefinedByDescriptorsApi->postCourseDefinedByDescriptor: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
putCourseDefinedByDescriptor($id, $ed_fi_course_defined_by_descriptor, $if_match)
```
...
try {
    $apiInstance->putCourseDefinedByDescriptor($id, $ed_fi_course_defined_by_descriptor, $if_match);
} catch (Exception $e) {
    echo 'Exception when calling CourseDefinedByDescriptorsApi->putCourseDefinedByDescriptor: ', $e->getMessage(), PHP_EOL;
}
```
