# OpenAPI\Client\StaffClassificationDescriptorsApi
...
$apiInstance = new OpenAPI\Client\Api\StaffClassificationDescriptorsApi(
...
```php
deletesStaffClassificationDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiStaffClassificationDescriptorDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiStaffClassificationDescriptorDelete[]**](../Model/TrackedChangesEdFiStaffClassificationDescriptorDelete.md)
...
```php
getStaffClassificationDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $staff_classification_descriptor_id, $use_snapshot): \OpenAPI\Client\Model\EdFiStaffClassificationDescriptor[]
```
...
[**\OpenAPI\Client\Model\EdFiStaffClassificationDescriptor[]**](../Model/EdFiStaffClassificationDescriptor.md)
...
```php
getStaffClassificationDescriptorsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiStaffClassificationDescriptor
```
...
```php
keyChangesStaffClassificationDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiStaffClassificationDescriptorKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiStaffClassificationDescriptorKeyChange[]**](../Model/TrackedChangesEdFiStaffClassificationDescriptorKeyChange.md)
...
$ed_fi_staff_classification_descriptor = new \OpenAPI\Client\Model\EdFiStaffClassificationDescriptor(); // \OpenAPI\Client\Model\EdFiStaffClassificationDescriptor | The JSON representation of the \"staffClassificationDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_staff_classification_descriptor** | [**\OpenAPI\Client\Model\EdFiStaffClassificationDescriptor**](../Model/EdFiStaffClassificationDescriptor.md)| The JSON representation of the \&quot;staffClassificationDescriptor\&quot; resource to be created or updated. | |
