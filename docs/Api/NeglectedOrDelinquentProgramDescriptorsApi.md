# OpenAPI\Client\NeglectedOrDelinquentProgramDescriptorsApi
...
$apiInstance = new OpenAPI\Client\Api\NeglectedOrDelinquentProgramDescriptorsApi(
...
```php
deletesNeglectedOrDelinquentProgramDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorDelete[]**](../Model/TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorDelete.md)
...
```php
getNeglectedOrDelinquentProgramDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $neglected_or_delinquent_program_descriptor_id, $use_snapshot): \OpenAPI\Client\Model\EdFiNeglectedOrDelinquentProgramDescriptor[]
```
...
[**\OpenAPI\Client\Model\EdFiNeglectedOrDelinquentProgramDescriptor[]**](../Model/EdFiNeglectedOrDelinquentProgramDescriptor.md)
...
```php
getNeglectedOrDelinquentProgramDescriptorsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiNeglectedOrDelinquentProgramDescriptor
```
...
```php
keyChangesNeglectedOrDelinquentProgramDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorKeyChange[]**](../Model/TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorKeyChange.md)
...
$ed_fi_neglected_or_delinquent_program_descriptor = new \OpenAPI\Client\Model\EdFiNeglectedOrDelinquentProgramDescriptor(); // \OpenAPI\Client\Model\EdFiNeglectedOrDelinquentProgramDescriptor | The JSON representation of the \"neglectedOrDelinquentProgramDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_neglected_or_delinquent_program_descriptor** | [**\OpenAPI\Client\Model\EdFiNeglectedOrDelinquentProgramDescriptor**](../Model/EdFiNeglectedOrDelinquentProgramDescriptor.md)| The JSON representation of the \&quot;neglectedOrDelinquentProgramDescriptor\&quot; resource to be created or updated. | |
