# Descriptors\InstitutionTelephoneNumberTypeDescriptorsApi
...
$apiInstance = new Descriptors\Api\InstitutionTelephoneNumberTypeDescriptorsApi(
...
```php
deletesInstitutionTelephoneNumberTypeDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Descriptors\Model\TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorDelete[]
```
...
[**\Descriptors\Model\TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorDelete[]**](../Model/TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorDelete.md)
...
```php
getInstitutionTelephoneNumberTypeDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\EdFiInstitutionTelephoneNumberTypeDescriptor[]
```
...
try {
    $result = $apiInstance->getInstitutionTelephoneNumberTypeDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\Descriptors\Model\EdFiInstitutionTelephoneNumberTypeDescriptor[]**](../Model/EdFiInstitutionTelephoneNumberTypeDescriptor.md)
...
```php
getInstitutionTelephoneNumberTypeDescriptorsById($id, $if_none_match, $use_snapshot): \Descriptors\Model\EdFiInstitutionTelephoneNumberTypeDescriptor
```
...
```php
getInstitutionTelephoneNumberTypeDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\GetAbsenceEventCategoryDescriptorsPartitions200Response
```
...
try {
    $result = $apiInstance->getInstitutionTelephoneNumberTypeDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling InstitutionTelephoneNumberTypeDescriptorsApi->getInstitutionTelephoneNumberTypeDescriptorsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
keyChangesInstitutionTelephoneNumberTypeDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Descriptors\Model\TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorKeyChange[]
```
...
[**\Descriptors\Model\TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorKeyChange[]**](../Model/TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorKeyChange.md)
...
$ed_fi_institution_telephone_number_type_descriptor = new \Descriptors\Model\EdFiInstitutionTelephoneNumberTypeDescriptor(); // \Descriptors\Model\EdFiInstitutionTelephoneNumberTypeDescriptor | The JSON representation of the \"institutionTelephoneNumberTypeDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_institution_telephone_number_type_descriptor** | [**\Descriptors\Model\EdFiInstitutionTelephoneNumberTypeDescriptor**](../Model/EdFiInstitutionTelephoneNumberTypeDescriptor.md)| The JSON representation of the \&quot;institutionTelephoneNumberTypeDescriptor\&quot; resource to be created or updated. | |
