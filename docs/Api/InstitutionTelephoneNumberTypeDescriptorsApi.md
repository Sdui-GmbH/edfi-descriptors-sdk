...
```php
getInstitutionTelephoneNumberTypeDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $institution_telephone_number_type_descriptor_id, $use_snapshot): \Descriptors\Model\EdFiInstitutionTelephoneNumberTypeDescriptor[]
```
