# Descriptors\BarrierToInternetAccessInResidenceDescriptorsApi
...
| [**getBarrierToInternetAccessInResidenceDescriptorsPartitions()**](BarrierToInternetAccessInResidenceDescriptorsApi.md#getBarrierToInternetAccessInResidenceDescriptorsPartitions) | **GET** /ed-fi/barrierToInternetAccessInResidenceDescriptors/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing. |
...
$apiInstance = new Descriptors\Api\BarrierToInternetAccessInResidenceDescriptorsApi(
...
```php
deletesBarrierToInternetAccessInResidenceDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Descriptors\Model\TrackedChangesEdFiBarrierToInternetAccessInResidenceDescriptorDelete[]
```
...
[**\Descriptors\Model\TrackedChangesEdFiBarrierToInternetAccessInResidenceDescriptorDelete[]**](../Model/TrackedChangesEdFiBarrierToInternetAccessInResidenceDescriptorDelete.md)
...
```php
getBarrierToInternetAccessInResidenceDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\EdFiBarrierToInternetAccessInResidenceDescriptor[]
```
...
try {
    $result = $apiInstance->getBarrierToInternetAccessInResidenceDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\Descriptors\Model\EdFiBarrierToInternetAccessInResidenceDescriptor[]**](../Model/EdFiBarrierToInternetAccessInResidenceDescriptor.md)
...
```php
getBarrierToInternetAccessInResidenceDescriptorsById($id, $if_none_match, $use_snapshot): \Descriptors\Model\EdFiBarrierToInternetAccessInResidenceDescriptor
```
...
```php
getBarrierToInternetAccessInResidenceDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\GetAbsenceEventCategoryDescriptorsPartitions200Response
```
...
try {
    $result = $apiInstance->getBarrierToInternetAccessInResidenceDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BarrierToInternetAccessInResidenceDescriptorsApi->getBarrierToInternetAccessInResidenceDescriptorsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
keyChangesBarrierToInternetAccessInResidenceDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Descriptors\Model\TrackedChangesEdFiBarrierToInternetAccessInResidenceDescriptorKeyChange[]
```
...
[**\Descriptors\Model\TrackedChangesEdFiBarrierToInternetAccessInResidenceDescriptorKeyChange[]**](../Model/TrackedChangesEdFiBarrierToInternetAccessInResidenceDescriptorKeyChange.md)
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_barrier_to_internet_access_in_residence_descriptor** | [**\Descriptors\Model\EdFiBarrierToInternetAccessInResidenceDescriptor**](../Model/EdFiBarrierToInternetAccessInResidenceDescriptor.md)| The JSON representation of the \&quot;barrierToInternetAccessInResidenceDescriptor\&quot; resource to be created or updated. | |
