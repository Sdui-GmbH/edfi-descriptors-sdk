...
```php
getBarrierToInternetAccessInResidenceDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $barrier_to_internet_access_in_residence_descriptor_id, $use_snapshot): \Descriptors\Model\EdFiBarrierToInternetAccessInResidenceDescriptor[]
```
