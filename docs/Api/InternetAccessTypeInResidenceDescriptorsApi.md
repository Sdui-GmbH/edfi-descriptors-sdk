# OpenAPI\Client\InternetAccessTypeInResidenceDescriptorsApi
...
$apiInstance = new OpenAPI\Client\Api\InternetAccessTypeInResidenceDescriptorsApi(
...
```php
deletesInternetAccessTypeInResidenceDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiInternetAccessTypeInResidenceDescriptorDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiInternetAccessTypeInResidenceDescriptorDelete[]**](../Model/TrackedChangesEdFiInternetAccessTypeInResidenceDescriptorDelete.md)
...
```php
getInternetAccessTypeInResidenceDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $internet_access_type_in_residence_descriptor_id, $use_snapshot): \OpenAPI\Client\Model\EdFiInternetAccessTypeInResidenceDescriptor[]
```
...
[**\OpenAPI\Client\Model\EdFiInternetAccessTypeInResidenceDescriptor[]**](../Model/EdFiInternetAccessTypeInResidenceDescriptor.md)
...
```php
getInternetAccessTypeInResidenceDescriptorsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiInternetAccessTypeInResidenceDescriptor
```
...
```php
keyChangesInternetAccessTypeInResidenceDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiInternetAccessTypeInResidenceDescriptorKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiInternetAccessTypeInResidenceDescriptorKeyChange[]**](../Model/TrackedChangesEdFiInternetAccessTypeInResidenceDescriptorKeyChange.md)
...
$ed_fi_internet_access_type_in_residence_descriptor = new \OpenAPI\Client\Model\EdFiInternetAccessTypeInResidenceDescriptor(); // \OpenAPI\Client\Model\EdFiInternetAccessTypeInResidenceDescriptor | The JSON representation of the \"internetAccessTypeInResidenceDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_internet_access_type_in_residence_descriptor** | [**\OpenAPI\Client\Model\EdFiInternetAccessTypeInResidenceDescriptor**](../Model/EdFiInternetAccessTypeInResidenceDescriptor.md)| The JSON representation of the \&quot;internetAccessTypeInResidenceDescriptor\&quot; resource to be created or updated. | |
