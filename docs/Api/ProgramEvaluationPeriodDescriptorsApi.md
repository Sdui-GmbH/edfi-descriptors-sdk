# Descriptors\ProgramEvaluationPeriodDescriptorsApi
...
| [**getProgramEvaluationPeriodDescriptorsPartitions()**](ProgramEvaluationPeriodDescriptorsApi.md#getProgramEvaluationPeriodDescriptorsPartitions) | **GET** /ed-fi/programEvaluationPeriodDescriptors/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing. |
...
$apiInstance = new Descriptors\Api\ProgramEvaluationPeriodDescriptorsApi(
...
```php
deletesProgramEvaluationPeriodDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Descriptors\Model\TrackedChangesEdFiProgramEvaluationPeriodDescriptorDelete[]
```
...
[**\Descriptors\Model\TrackedChangesEdFiProgramEvaluationPeriodDescriptorDelete[]**](../Model/TrackedChangesEdFiProgramEvaluationPeriodDescriptorDelete.md)
...
```php
getProgramEvaluationPeriodDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\EdFiProgramEvaluationPeriodDescriptor[]
```
...
try {
    $result = $apiInstance->getProgramEvaluationPeriodDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\Descriptors\Model\EdFiProgramEvaluationPeriodDescriptor[]**](../Model/EdFiProgramEvaluationPeriodDescriptor.md)
...
```php
getProgramEvaluationPeriodDescriptorsById($id, $if_none_match, $use_snapshot): \Descriptors\Model\EdFiProgramEvaluationPeriodDescriptor
```
...
## `getProgramEvaluationPeriodDescriptorsPartitions()`

```php
getProgramEvaluationPeriodDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\GetAbsenceEventCategoryDescriptorsPartitions200Response
```
...
try {
    $result = $apiInstance->getProgramEvaluationPeriodDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ProgramEvaluationPeriodDescriptorsApi->getProgramEvaluationPeriodDescriptorsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
keyChangesProgramEvaluationPeriodDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Descriptors\Model\TrackedChangesEdFiProgramEvaluationPeriodDescriptorKeyChange[]
```
...
[**\Descriptors\Model\TrackedChangesEdFiProgramEvaluationPeriodDescriptorKeyChange[]**](../Model/TrackedChangesEdFiProgramEvaluationPeriodDescriptorKeyChange.md)
...
$ed_fi_program_evaluation_period_descriptor = new \Descriptors\Model\EdFiProgramEvaluationPeriodDescriptor(); // \Descriptors\Model\EdFiProgramEvaluationPeriodDescriptor | The JSON representation of the \"programEvaluationPeriodDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_program_evaluation_period_descriptor** | [**\Descriptors\Model\EdFiProgramEvaluationPeriodDescriptor**](../Model/EdFiProgramEvaluationPeriodDescriptor.md)| The JSON representation of the \&quot;programEvaluationPeriodDescriptor\&quot; resource to be created or updated. | |
