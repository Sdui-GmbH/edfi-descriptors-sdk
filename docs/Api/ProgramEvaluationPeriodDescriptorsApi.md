...
```php
getProgramEvaluationPeriodDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $program_evaluation_period_descriptor_id, $use_snapshot): \Descriptors\Model\EdFiProgramEvaluationPeriodDescriptor[]
```
