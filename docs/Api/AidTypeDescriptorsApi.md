# Descriptors\AidTypeDescriptorsApi
...
```php
getAidTypeDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $aid_type_descriptor_id, $use_snapshot): \Descriptors\Model\TpdmAidTypeDescriptor[]
```
