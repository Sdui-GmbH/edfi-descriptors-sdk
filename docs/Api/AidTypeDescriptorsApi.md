# OpenAPI\Client\AidTypeDescriptorsApi
...
$apiInstance = new OpenAPI\Client\Api\AidTypeDescriptorsApi(
...
```php
deletesAidTypeDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesTpdmAidTypeDescriptorDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesTpdmAidTypeDescriptorDelete[]**](../Model/TrackedChangesTpdmAidTypeDescriptorDelete.md)
...
```php
getAidTypeDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $aid_type_descriptor_id, $use_snapshot): \OpenAPI\Client\Model\TpdmAidTypeDescriptor[]
```
...
$max_change_version = 56; // int | Used in synchronization to set sequence maximum ChangeVersion
$total_count = false; // bool | Indicates if the total number of items available should be returned in the 'Total-Count' header of the response.  If set to false, 'Total-Count' header will not be provided.
$aid_type_descriptor_id = 56; // int | A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
$use_snapshot = false; // bool | Indicates if the configured Snapshot should be used.

try {
    $result = $apiInstance->getAidTypeDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $aid_type_descriptor_id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
| **max_change_version** | **int**| Used in synchronization to set sequence maximum ChangeVersion | [optional] |
| **total_count** | **bool**| Indicates if the total number of items available should be returned in the &#39;Total-Count&#39; header of the response.  If set to false, &#39;Total-Count&#39; header will not be provided. | [optional] [default to false] |
| **aid_type_descriptor_id** | **int**| A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table. | [optional] |
| **use_snapshot** | **bool**| Indicates if the configured Snapshot should be used. | [optional] [default to false] |

### Return type

[**\OpenAPI\Client\Model\TpdmAidTypeDescriptor[]**](../Model/TpdmAidTypeDescriptor.md)
...
```php
getAidTypeDescriptorsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\TpdmAidTypeDescriptor
```
...
```php
keyChangesAidTypeDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesTpdmAidTypeDescriptorKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesTpdmAidTypeDescriptorKeyChange[]**](../Model/TrackedChangesTpdmAidTypeDescriptorKeyChange.md)
...
$tpdm_aid_type_descriptor = new \OpenAPI\Client\Model\TpdmAidTypeDescriptor(); // \OpenAPI\Client\Model\TpdmAidTypeDescriptor | The JSON representation of the \"aidTypeDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **tpdm_aid_type_descriptor** | [**\OpenAPI\Client\Model\TpdmAidTypeDescriptor**](../Model/TpdmAidTypeDescriptor.md)| The JSON representation of the \&quot;aidTypeDescriptor\&quot; resource to be created or updated. | |
