# Descriptors\SurveyCategoryDescriptorsApi
...
```php
getSurveyCategoryDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $survey_category_descriptor_id, $use_snapshot): \Descriptors\Model\EdFiSurveyCategoryDescriptor[]
```
