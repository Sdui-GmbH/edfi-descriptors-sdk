# OpenAPI\Client\AttemptStatusDescriptorsApi
...
$apiInstance = new OpenAPI\Client\Api\AttemptStatusDescriptorsApi(
...
```php
deletesAttemptStatusDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiAttemptStatusDescriptorDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiAttemptStatusDescriptorDelete[]**](../Model/TrackedChangesEdFiAttemptStatusDescriptorDelete.md)
...
```php
getAttemptStatusDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $attempt_status_descriptor_id, $use_snapshot): \OpenAPI\Client\Model\EdFiAttemptStatusDescriptor[]
```
...
$max_change_version = 56; // int | Used in synchronization to set sequence maximum ChangeVersion
$total_count = false; // bool | Indicates if the total number of items available should be returned in the 'Total-Count' header of the response.  If set to false, 'Total-Count' header will not be provided.
$attempt_status_descriptor_id = 56; // int | A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
$use_snapshot = false; // bool | Indicates if the configured Snapshot should be used.

try {
    $result = $apiInstance->getAttemptStatusDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $attempt_status_descriptor_id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
| **max_change_version** | **int**| Used in synchronization to set sequence maximum ChangeVersion | [optional] |
| **total_count** | **bool**| Indicates if the total number of items available should be returned in the &#39;Total-Count&#39; header of the response.  If set to false, &#39;Total-Count&#39; header will not be provided. | [optional] [default to false] |
| **attempt_status_descriptor_id** | **int**| A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table. | [optional] |
| **use_snapshot** | **bool**| Indicates if the configured Snapshot should be used. | [optional] [default to false] |

### Return type

[**\OpenAPI\Client\Model\EdFiAttemptStatusDescriptor[]**](../Model/EdFiAttemptStatusDescriptor.md)
...
```php
getAttemptStatusDescriptorsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiAttemptStatusDescriptor
```
...
```php
keyChangesAttemptStatusDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiAttemptStatusDescriptorKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiAttemptStatusDescriptorKeyChange[]**](../Model/TrackedChangesEdFiAttemptStatusDescriptorKeyChange.md)
...
$ed_fi_attempt_status_descriptor = new \OpenAPI\Client\Model\EdFiAttemptStatusDescriptor(); // \OpenAPI\Client\Model\EdFiAttemptStatusDescriptor | The JSON representation of the \"attemptStatusDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_attempt_status_descriptor** | [**\OpenAPI\Client\Model\EdFiAttemptStatusDescriptor**](../Model/EdFiAttemptStatusDescriptor.md)| The JSON representation of the \&quot;attemptStatusDescriptor\&quot; resource to be created or updated. | |
