# Descriptors\AttemptStatusDescriptorsApi
...
```php
getAttemptStatusDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $attempt_status_descriptor_id, $use_snapshot): \Descriptors\Model\EdFiAttemptStatusDescriptor[]
```
