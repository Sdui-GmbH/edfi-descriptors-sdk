...
| [**getReporterDescriptionDescriptorsPartitions()**](ReporterDescriptionDescriptorsApi.md#getReporterDescriptionDescriptorsPartitions) | **GET** /ed-fi/reporterDescriptionDescriptors/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing. |
...
try {
    $apiInstance->deleteReporterDescriptionDescriptorById($id, $if_match);
} catch (Exception $e) {
    echo 'Exception when calling ReporterDescriptionDescriptorsApi->deleteReporterDescriptionDescriptorById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->deletesReporterDescriptionDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ReporterDescriptionDescriptorsApi->deletesReporterDescriptionDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getReporterDescriptionDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\EdFiReporterDescriptionDescriptor[]
```
...
try {
    $result = $apiInstance->getReporterDescriptionDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ReporterDescriptionDescriptorsApi->getReporterDescriptionDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->getReporterDescriptionDescriptorsById($id, $if_none_match, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ReporterDescriptionDescriptorsApi->getReporterDescriptionDescriptorsById: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getReporterDescriptionDescriptorsPartitions()`

```php
getReporterDescriptionDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\GetAbsenceEventCategoryDescriptorsPartitions200Response
```
...
try {
    $result = $apiInstance->getReporterDescriptionDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ReporterDescriptionDescriptorsApi->getReporterDescriptionDescriptorsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->keyChangesReporterDescriptionDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ReporterDescriptionDescriptorsApi->keyChangesReporterDescriptionDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
postReporterDescriptionDescriptor($ed_fi_reporter_description_descriptor)
```
...
try {
    ...
    echo 'Exception when calling ReporterDescriptionDescriptorsApi->postReporterDescriptionDescriptor: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
putReporterDescriptionDescriptor($id, $ed_fi_reporter_description_descriptor, $if_match)
```
...
try {
    $apiInstance->putReporterDescriptionDescriptor($id, $ed_fi_reporter_description_descriptor, $if_match);
} catch (Exception $e) {
    echo 'Exception when calling ReporterDescriptionDescriptorsApi->putReporterDescriptionDescriptor: ', $e->getMessage(), PHP_EOL;
}
```
