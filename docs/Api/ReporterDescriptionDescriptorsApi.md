...
try {
    $result = $apiInstance->getReporterDescriptionDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $reporter_description_descriptor_id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
