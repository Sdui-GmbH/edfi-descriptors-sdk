# OpenAPI\Client\AssessmentPeriodDescriptorsApi
...
$apiInstance = new OpenAPI\Client\Api\AssessmentPeriodDescriptorsApi(
...
```php
deletesAssessmentPeriodDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiAssessmentPeriodDescriptorDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiAssessmentPeriodDescriptorDelete[]**](../Model/TrackedChangesEdFiAssessmentPeriodDescriptorDelete.md)
...
```php
getAssessmentPeriodDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $assessment_period_descriptor_id, $use_snapshot): \OpenAPI\Client\Model\EdFiAssessmentPeriodDescriptor[]
```
...
[**\OpenAPI\Client\Model\EdFiAssessmentPeriodDescriptor[]**](../Model/EdFiAssessmentPeriodDescriptor.md)
...
```php
getAssessmentPeriodDescriptorsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiAssessmentPeriodDescriptor
```
...
```php
keyChangesAssessmentPeriodDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiAssessmentPeriodDescriptorKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiAssessmentPeriodDescriptorKeyChange[]**](../Model/TrackedChangesEdFiAssessmentPeriodDescriptorKeyChange.md)
...
$ed_fi_assessment_period_descriptor = new \OpenAPI\Client\Model\EdFiAssessmentPeriodDescriptor(); // \OpenAPI\Client\Model\EdFiAssessmentPeriodDescriptor | The JSON representation of the \"assessmentPeriodDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_assessment_period_descriptor** | [**\OpenAPI\Client\Model\EdFiAssessmentPeriodDescriptor**](../Model/EdFiAssessmentPeriodDescriptor.md)| The JSON representation of the \&quot;assessmentPeriodDescriptor\&quot; resource to be created or updated. | |
