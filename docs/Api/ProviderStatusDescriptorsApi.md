...
```php
getProviderStatusDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $provider_status_descriptor_id, $use_snapshot): \Descriptors\Model\EdFiProviderStatusDescriptor[]
```
