# OpenAPI\Client\ProviderStatusDescriptorsApi
...
$apiInstance = new OpenAPI\Client\Api\ProviderStatusDescriptorsApi(
...
```php
deletesProviderStatusDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiProviderStatusDescriptorDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiProviderStatusDescriptorDelete[]**](../Model/TrackedChangesEdFiProviderStatusDescriptorDelete.md)
...
```php
getProviderStatusDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $provider_status_descriptor_id, $use_snapshot): \OpenAPI\Client\Model\EdFiProviderStatusDescriptor[]
```
...
$max_change_version = 56; // int | Used in synchronization to set sequence maximum ChangeVersion
$total_count = false; // bool | Indicates if the total number of items available should be returned in the 'Total-Count' header of the response.  If set to false, 'Total-Count' header will not be provided.
$provider_status_descriptor_id = 56; // int | A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
$use_snapshot = false; // bool | Indicates if the configured Snapshot should be used.

try {
    $result = $apiInstance->getProviderStatusDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $provider_status_descriptor_id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
| **max_change_version** | **int**| Used in synchronization to set sequence maximum ChangeVersion | [optional] |
| **total_count** | **bool**| Indicates if the total number of items available should be returned in the &#39;Total-Count&#39; header of the response.  If set to false, &#39;Total-Count&#39; header will not be provided. | [optional] [default to false] |
| **provider_status_descriptor_id** | **int**| A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table. | [optional] |
| **use_snapshot** | **bool**| Indicates if the configured Snapshot should be used. | [optional] [default to false] |

### Return type

[**\OpenAPI\Client\Model\EdFiProviderStatusDescriptor[]**](../Model/EdFiProviderStatusDescriptor.md)
...
```php
getProviderStatusDescriptorsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiProviderStatusDescriptor
```
...
```php
keyChangesProviderStatusDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiProviderStatusDescriptorKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiProviderStatusDescriptorKeyChange[]**](../Model/TrackedChangesEdFiProviderStatusDescriptorKeyChange.md)
...
$ed_fi_provider_status_descriptor = new \OpenAPI\Client\Model\EdFiProviderStatusDescriptor(); // \OpenAPI\Client\Model\EdFiProviderStatusDescriptor | The JSON representation of the \"providerStatusDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_provider_status_descriptor** | [**\OpenAPI\Client\Model\EdFiProviderStatusDescriptor**](../Model/EdFiProviderStatusDescriptor.md)| The JSON representation of the \&quot;providerStatusDescriptor\&quot; resource to be created or updated. | |
