# Descriptors\PerformanceEvaluationRatingLevelDescriptorsApi
...
$apiInstance = new Descriptors\Api\PerformanceEvaluationRatingLevelDescriptorsApi(
...
```php
deletesPerformanceEvaluationRatingLevelDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Descriptors\Model\TrackedChangesTpdmPerformanceEvaluationRatingLevelDescriptorDelete[]
```
...
[**\Descriptors\Model\TrackedChangesTpdmPerformanceEvaluationRatingLevelDescriptorDelete[]**](../Model/TrackedChangesTpdmPerformanceEvaluationRatingLevelDescriptorDelete.md)
...
try {
    $result = $apiInstance->getPerformanceEvaluationRatingLevelDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\Descriptors\Model\TpdmPerformanceEvaluationRatingLevelDescriptor[]**](../Model/TpdmPerformanceEvaluationRatingLevelDescriptor.md)
...
```php
getPerformanceEvaluationRatingLevelDescriptorsById($id, $if_none_match, $use_snapshot): \Descriptors\Model\TpdmPerformanceEvaluationRatingLevelDescriptor
```
...
```php
getPerformanceEvaluationRatingLevelDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\GetAbsenceEventCategoryDescriptorsPartitions200Response
```
...
try {
    $result = $apiInstance->getPerformanceEvaluationRatingLevelDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PerformanceEvaluationRatingLevelDescriptorsApi->getPerformanceEvaluationRatingLevelDescriptorsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
keyChangesPerformanceEvaluationRatingLevelDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Descriptors\Model\TrackedChangesTpdmPerformanceEvaluationRatingLevelDescriptorKeyChange[]
```
...
[**\Descriptors\Model\TrackedChangesTpdmPerformanceEvaluationRatingLevelDescriptorKeyChange[]**](../Model/TrackedChangesTpdmPerformanceEvaluationRatingLevelDescriptorKeyChange.md)
...
$tpdm_performance_evaluation_rating_level_descriptor = new \Descriptors\Model\TpdmPerformanceEvaluationRatingLevelDescriptor(); // \Descriptors\Model\TpdmPerformanceEvaluationRatingLevelDescriptor | The JSON representation of the \"performanceEvaluationRatingLevelDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **tpdm_performance_evaluation_rating_level_descriptor** | [**\Descriptors\Model\TpdmPerformanceEvaluationRatingLevelDescriptor**](../Model/TpdmPerformanceEvaluationRatingLevelDescriptor.md)| The JSON representation of the \&quot;performanceEvaluationRatingLevelDescriptor\&quot; resource to be created or updated. | |
