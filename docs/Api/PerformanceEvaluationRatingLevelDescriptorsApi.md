...
```php
getPerformanceEvaluationRatingLevelDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $performance_evaluation_rating_level_descriptor_id, $use_snapshot): \Descriptors\Model\TpdmPerformanceEvaluationRatingLevelDescriptor[]
```
