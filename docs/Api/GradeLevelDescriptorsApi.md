# Descriptors\GradeLevelDescriptorsApi
...
$apiInstance = new Descriptors\Api\GradeLevelDescriptorsApi(
...
try {
    $apiInstance->deleteGradeLevelDescriptorById($id, $if_match);
} catch (Exception $e) {
    echo 'Exception when calling GradeLevelDescriptorsApi->deleteGradeLevelDescriptorById: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deletesGradeLevelDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Descriptors\Model\TrackedChangesEdFiGradeLevelDescriptorDelete[]
```
...
try {
    $result = $apiInstance->deletesGradeLevelDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling GradeLevelDescriptorsApi->deletesGradeLevelDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\Descriptors\Model\TrackedChangesEdFiGradeLevelDescriptorDelete[]**](../Model/TrackedChangesEdFiGradeLevelDescriptorDelete.md)
...
```php
getGradeLevelDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\EdFiGradeLevelDescriptor[]
```
...
try {
    $result = $apiInstance->getGradeLevelDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling GradeLevelDescriptorsApi->getGradeLevelDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\Descriptors\Model\EdFiGradeLevelDescriptor[]**](../Model/EdFiGradeLevelDescriptor.md)
...
```php
getGradeLevelDescriptorsById($id, $if_none_match, $use_snapshot): \Descriptors\Model\EdFiGradeLevelDescriptor
```
...
try {
    $result = $apiInstance->getGradeLevelDescriptorsById($id, $if_none_match, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling GradeLevelDescriptorsApi->getGradeLevelDescriptorsById: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getGradeLevelDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\GetAbsenceEventCategoryDescriptorsPartitions200Response
```
...
try {
    $result = $apiInstance->getGradeLevelDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling GradeLevelDescriptorsApi->getGradeLevelDescriptorsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
keyChangesGradeLevelDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Descriptors\Model\TrackedChangesEdFiGradeLevelDescriptorKeyChange[]
```
...
try {
    $result = $apiInstance->keyChangesGradeLevelDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling GradeLevelDescriptorsApi->keyChangesGradeLevelDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\Descriptors\Model\TrackedChangesEdFiGradeLevelDescriptorKeyChange[]**](../Model/TrackedChangesEdFiGradeLevelDescriptorKeyChange.md)
...
```php
postGradeLevelDescriptor($ed_fi_grade_level_descriptor)
```
...
$ed_fi_grade_level_descriptor = new \Descriptors\Model\EdFiGradeLevelDescriptor(); // \Descriptors\Model\EdFiGradeLevelDescriptor | The JSON representation of the \"gradeLevelDescriptor\" resource to be created or updated.

try {
    $apiInstance->postGradeLevelDescriptor($ed_fi_grade_level_descriptor);
} catch (Exception $e) {
    echo 'Exception when calling GradeLevelDescriptorsApi->postGradeLevelDescriptor: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_grade_level_descriptor** | [**\Descriptors\Model\EdFiGradeLevelDescriptor**](../Model/EdFiGradeLevelDescriptor.md)| The JSON representation of the \&quot;gradeLevelDescriptor\&quot; resource to be created or updated. | |
...
```php
putGradeLevelDescriptor($id, $ed_fi_grade_level_descriptor, $if_match)
```
...
try {
    $apiInstance->putGradeLevelDescriptor($id, $ed_fi_grade_level_descriptor, $if_match);
} catch (Exception $e) {
    echo 'Exception when calling GradeLevelDescriptorsApi->putGradeLevelDescriptor: ', $e->getMessage(), PHP_EOL;
}
```
