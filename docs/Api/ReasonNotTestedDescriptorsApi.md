...
```php
getReasonNotTestedDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $reason_not_tested_descriptor_id, $use_snapshot): \Descriptors\Model\EdFiReasonNotTestedDescriptor[]
```
