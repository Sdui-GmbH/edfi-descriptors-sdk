# Descriptors\ReasonNotTestedDescriptorsApi
...
| [**getReasonNotTestedDescriptorsPartitions()**](ReasonNotTestedDescriptorsApi.md#getReasonNotTestedDescriptorsPartitions) | **GET** /ed-fi/reasonNotTestedDescriptors/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing. |
...
$apiInstance = new Descriptors\Api\ReasonNotTestedDescriptorsApi(
...
```php
deletesReasonNotTestedDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Descriptors\Model\TrackedChangesEdFiReasonNotTestedDescriptorDelete[]
```
...
[**\Descriptors\Model\TrackedChangesEdFiReasonNotTestedDescriptorDelete[]**](../Model/TrackedChangesEdFiReasonNotTestedDescriptorDelete.md)
...
```php
getReasonNotTestedDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\EdFiReasonNotTestedDescriptor[]
```
...
try {
    $result = $apiInstance->getReasonNotTestedDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\Descriptors\Model\EdFiReasonNotTestedDescriptor[]**](../Model/EdFiReasonNotTestedDescriptor.md)
...
```php
getReasonNotTestedDescriptorsById($id, $if_none_match, $use_snapshot): \Descriptors\Model\EdFiReasonNotTestedDescriptor
```
...
## `getReasonNotTestedDescriptorsPartitions()`

```php
getReasonNotTestedDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\GetAbsenceEventCategoryDescriptorsPartitions200Response
```
...
try {
    $result = $apiInstance->getReasonNotTestedDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ReasonNotTestedDescriptorsApi->getReasonNotTestedDescriptorsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
keyChangesReasonNotTestedDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Descriptors\Model\TrackedChangesEdFiReasonNotTestedDescriptorKeyChange[]
```
...
[**\Descriptors\Model\TrackedChangesEdFiReasonNotTestedDescriptorKeyChange[]**](../Model/TrackedChangesEdFiReasonNotTestedDescriptorKeyChange.md)
...
$ed_fi_reason_not_tested_descriptor = new \Descriptors\Model\EdFiReasonNotTestedDescriptor(); // \Descriptors\Model\EdFiReasonNotTestedDescriptor | The JSON representation of the \"reasonNotTestedDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_reason_not_tested_descriptor** | [**\Descriptors\Model\EdFiReasonNotTestedDescriptor**](../Model/EdFiReasonNotTestedDescriptor.md)| The JSON representation of the \&quot;reasonNotTestedDescriptor\&quot; resource to be created or updated. | |
