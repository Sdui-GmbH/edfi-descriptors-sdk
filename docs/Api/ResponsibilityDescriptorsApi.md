# OpenAPI\Client\ResponsibilityDescriptorsApi
...
$apiInstance = new OpenAPI\Client\Api\ResponsibilityDescriptorsApi(
...
```php
deletesResponsibilityDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiResponsibilityDescriptorDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiResponsibilityDescriptorDelete[]**](../Model/TrackedChangesEdFiResponsibilityDescriptorDelete.md)
...
```php
getResponsibilityDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $responsibility_descriptor_id, $use_snapshot): \OpenAPI\Client\Model\EdFiResponsibilityDescriptor[]
```
...
[**\OpenAPI\Client\Model\EdFiResponsibilityDescriptor[]**](../Model/EdFiResponsibilityDescriptor.md)
...
```php
getResponsibilityDescriptorsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiResponsibilityDescriptor
```
...
```php
keyChangesResponsibilityDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiResponsibilityDescriptorKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiResponsibilityDescriptorKeyChange[]**](../Model/TrackedChangesEdFiResponsibilityDescriptorKeyChange.md)
...
$ed_fi_responsibility_descriptor = new \OpenAPI\Client\Model\EdFiResponsibilityDescriptor(); // \OpenAPI\Client\Model\EdFiResponsibilityDescriptor | The JSON representation of the \"responsibilityDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_responsibility_descriptor** | [**\OpenAPI\Client\Model\EdFiResponsibilityDescriptor**](../Model/EdFiResponsibilityDescriptor.md)| The JSON representation of the \&quot;responsibilityDescriptor\&quot; resource to be created or updated. | |
