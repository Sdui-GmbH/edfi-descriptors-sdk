# OpenAPI\Client\CteProgramServiceDescriptorsApi
...
$apiInstance = new OpenAPI\Client\Api\CteProgramServiceDescriptorsApi(
...
```php
deletesCTEProgramServiceDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiCteProgramServiceDescriptorDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiCteProgramServiceDescriptorDelete[]**](../Model/TrackedChangesEdFiCteProgramServiceDescriptorDelete.md)
...
```php
getCTEProgramServiceDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $cte_program_service_descriptor_id, $use_snapshot): \OpenAPI\Client\Model\EdFiCteProgramServiceDescriptor[]
```
...
[**\OpenAPI\Client\Model\EdFiCteProgramServiceDescriptor[]**](../Model/EdFiCteProgramServiceDescriptor.md)
...
```php
getCTEProgramServiceDescriptorsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiCteProgramServiceDescriptor
```
...
```php
keyChangesCTEProgramServiceDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiCteProgramServiceDescriptorKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiCteProgramServiceDescriptorKeyChange[]**](../Model/TrackedChangesEdFiCteProgramServiceDescriptorKeyChange.md)
...
$ed_fi_cte_program_service_descriptor = new \OpenAPI\Client\Model\EdFiCteProgramServiceDescriptor(); // \OpenAPI\Client\Model\EdFiCteProgramServiceDescriptor | The JSON representation of the \"cteProgramServiceDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_cte_program_service_descriptor** | [**\OpenAPI\Client\Model\EdFiCteProgramServiceDescriptor**](../Model/EdFiCteProgramServiceDescriptor.md)| The JSON representation of the \&quot;cteProgramServiceDescriptor\&quot; resource to be created or updated. | |
