# OpenAPI\Client\CurriculumUsedDescriptorsApi
...
$apiInstance = new OpenAPI\Client\Api\CurriculumUsedDescriptorsApi(
...
```php
deletesCurriculumUsedDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiCurriculumUsedDescriptorDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiCurriculumUsedDescriptorDelete[]**](../Model/TrackedChangesEdFiCurriculumUsedDescriptorDelete.md)
...
```php
getCurriculumUsedDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $curriculum_used_descriptor_id, $use_snapshot): \OpenAPI\Client\Model\EdFiCurriculumUsedDescriptor[]
```
...
$max_change_version = 56; // int | Used in synchronization to set sequence maximum ChangeVersion
$total_count = false; // bool | Indicates if the total number of items available should be returned in the 'Total-Count' header of the response.  If set to false, 'Total-Count' header will not be provided.
$curriculum_used_descriptor_id = 56; // int | A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
$use_snapshot = false; // bool | Indicates if the configured Snapshot should be used.

try {
    $result = $apiInstance->getCurriculumUsedDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $curriculum_used_descriptor_id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
| **max_change_version** | **int**| Used in synchronization to set sequence maximum ChangeVersion | [optional] |
| **total_count** | **bool**| Indicates if the total number of items available should be returned in the &#39;Total-Count&#39; header of the response.  If set to false, &#39;Total-Count&#39; header will not be provided. | [optional] [default to false] |
| **curriculum_used_descriptor_id** | **int**| A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table. | [optional] |
| **use_snapshot** | **bool**| Indicates if the configured Snapshot should be used. | [optional] [default to false] |

### Return type

[**\OpenAPI\Client\Model\EdFiCurriculumUsedDescriptor[]**](../Model/EdFiCurriculumUsedDescriptor.md)
...
```php
getCurriculumUsedDescriptorsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiCurriculumUsedDescriptor
```
...
```php
keyChangesCurriculumUsedDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiCurriculumUsedDescriptorKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiCurriculumUsedDescriptorKeyChange[]**](../Model/TrackedChangesEdFiCurriculumUsedDescriptorKeyChange.md)
...
$ed_fi_curriculum_used_descriptor = new \OpenAPI\Client\Model\EdFiCurriculumUsedDescriptor(); // \OpenAPI\Client\Model\EdFiCurriculumUsedDescriptor | The JSON representation of the \"curriculumUsedDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_curriculum_used_descriptor** | [**\OpenAPI\Client\Model\EdFiCurriculumUsedDescriptor**](../Model/EdFiCurriculumUsedDescriptor.md)| The JSON representation of the \&quot;curriculumUsedDescriptor\&quot; resource to be created or updated. | |
