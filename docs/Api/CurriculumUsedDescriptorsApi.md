...
```php
getCurriculumUsedDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $curriculum_used_descriptor_id, $use_snapshot): \Descriptors\Model\EdFiCurriculumUsedDescriptor[]
```
