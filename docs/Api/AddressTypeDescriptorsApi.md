...
| [**getAddressTypeDescriptorsPartitions()**](AddressTypeDescriptorsApi.md#getAddressTypeDescriptorsPartitions) | **GET** /ed-fi/addressTypeDescriptors/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing. |
...
```php
deleteAddressTypeDescriptorById($id, $if_match)
```
...
try {
    $apiInstance->deleteAddressTypeDescriptorById($id, $if_match);
} catch (Exception $e) {
    echo 'Exception when calling AddressTypeDescriptorsApi->deleteAddressTypeDescriptorById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->deletesAddressTypeDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AddressTypeDescriptorsApi->deletesAddressTypeDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getAddressTypeDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\EdFiAddressTypeDescriptor[]
```
...
try {
    $result = $apiInstance->getAddressTypeDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AddressTypeDescriptorsApi->getAddressTypeDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->getAddressTypeDescriptorsById($id, $if_none_match, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AddressTypeDescriptorsApi->getAddressTypeDescriptorsById: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getAddressTypeDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\GetAbsenceEventCategoryDescriptorsPartitions200Response
```
...
try {
    $result = $apiInstance->getAddressTypeDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AddressTypeDescriptorsApi->getAddressTypeDescriptorsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->keyChangesAddressTypeDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AddressTypeDescriptorsApi->keyChangesAddressTypeDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
postAddressTypeDescriptor($ed_fi_address_type_descriptor)
```
...
try {
    ...
    echo 'Exception when calling AddressTypeDescriptorsApi->postAddressTypeDescriptor: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
putAddressTypeDescriptor($id, $ed_fi_address_type_descriptor, $if_match)
```
...
try {
    $apiInstance->putAddressTypeDescriptor($id, $ed_fi_address_type_descriptor, $if_match);
} catch (Exception $e) {
    echo 'Exception when calling AddressTypeDescriptorsApi->putAddressTypeDescriptor: ', $e->getMessage(), PHP_EOL;
}
```
