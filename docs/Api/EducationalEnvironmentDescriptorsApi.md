...
| [**getEducationalEnvironmentDescriptorsPartitions()**](EducationalEnvironmentDescriptorsApi.md#getEducationalEnvironmentDescriptorsPartitions) | **GET** /ed-fi/educationalEnvironmentDescriptors/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing. |
...
```php
deleteEducationalEnvironmentDescriptorById($id, $if_match)
```
...
try {
    $apiInstance->deleteEducationalEnvironmentDescriptorById($id, $if_match);
} catch (Exception $e) {
    echo 'Exception when calling EducationalEnvironmentDescriptorsApi->deleteEducationalEnvironmentDescriptorById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->deletesEducationalEnvironmentDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EducationalEnvironmentDescriptorsApi->deletesEducationalEnvironmentDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getEducationalEnvironmentDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\EdFiEducationalEnvironmentDescriptor[]
```
...
try {
    $result = $apiInstance->getEducationalEnvironmentDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EducationalEnvironmentDescriptorsApi->getEducationalEnvironmentDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->getEducationalEnvironmentDescriptorsById($id, $if_none_match, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EducationalEnvironmentDescriptorsApi->getEducationalEnvironmentDescriptorsById: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getEducationalEnvironmentDescriptorsPartitions()`

```php
getEducationalEnvironmentDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\GetAbsenceEventCategoryDescriptorsPartitions200Response
```
...
try {
    $result = $apiInstance->getEducationalEnvironmentDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EducationalEnvironmentDescriptorsApi->getEducationalEnvironmentDescriptorsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->keyChangesEducationalEnvironmentDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EducationalEnvironmentDescriptorsApi->keyChangesEducationalEnvironmentDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
postEducationalEnvironmentDescriptor($ed_fi_educational_environment_descriptor)
```
...
try {
    ...
    echo 'Exception when calling EducationalEnvironmentDescriptorsApi->postEducationalEnvironmentDescriptor: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
putEducationalEnvironmentDescriptor($id, $ed_fi_educational_environment_descriptor, $if_match)
```
...
try {
    $apiInstance->putEducationalEnvironmentDescriptor($id, $ed_fi_educational_environment_descriptor, $if_match);
} catch (Exception $e) {
    echo 'Exception when calling EducationalEnvironmentDescriptorsApi->putEducationalEnvironmentDescriptor: ', $e->getMessage(), PHP_EOL;
}
```
