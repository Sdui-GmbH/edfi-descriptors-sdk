# OpenAPI\Client\HomelessPrimaryNighttimeResidenceDescriptorsApi
...
$apiInstance = new OpenAPI\Client\Api\HomelessPrimaryNighttimeResidenceDescriptorsApi(
...
```php
deletesHomelessPrimaryNighttimeResidenceDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiHomelessPrimaryNighttimeResidenceDescriptorDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiHomelessPrimaryNighttimeResidenceDescriptorDelete[]**](../Model/TrackedChangesEdFiHomelessPrimaryNighttimeResidenceDescriptorDelete.md)
...
```php
getHomelessPrimaryNighttimeResidenceDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $homeless_primary_nighttime_residence_descriptor_id, $use_snapshot): \OpenAPI\Client\Model\EdFiHomelessPrimaryNighttimeResidenceDescriptor[]
```
...
[**\OpenAPI\Client\Model\EdFiHomelessPrimaryNighttimeResidenceDescriptor[]**](../Model/EdFiHomelessPrimaryNighttimeResidenceDescriptor.md)
...
```php
getHomelessPrimaryNighttimeResidenceDescriptorsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiHomelessPrimaryNighttimeResidenceDescriptor
```
...
```php
keyChangesHomelessPrimaryNighttimeResidenceDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiHomelessPrimaryNighttimeResidenceDescriptorKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiHomelessPrimaryNighttimeResidenceDescriptorKeyChange[]**](../Model/TrackedChangesEdFiHomelessPrimaryNighttimeResidenceDescriptorKeyChange.md)
...
$ed_fi_homeless_primary_nighttime_residence_descriptor = new \OpenAPI\Client\Model\EdFiHomelessPrimaryNighttimeResidenceDescriptor(); // \OpenAPI\Client\Model\EdFiHomelessPrimaryNighttimeResidenceDescriptor | The JSON representation of the \"homelessPrimaryNighttimeResidenceDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_homeless_primary_nighttime_residence_descriptor** | [**\OpenAPI\Client\Model\EdFiHomelessPrimaryNighttimeResidenceDescriptor**](../Model/EdFiHomelessPrimaryNighttimeResidenceDescriptor.md)| The JSON representation of the \&quot;homelessPrimaryNighttimeResidenceDescriptor\&quot; resource to be created or updated. | |
