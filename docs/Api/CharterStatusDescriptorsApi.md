...
| [**getCharterStatusDescriptorsPartitions()**](CharterStatusDescriptorsApi.md#getCharterStatusDescriptorsPartitions) | **GET** /ed-fi/charterStatusDescriptors/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing. |
...
```php
deleteCharterStatusDescriptorById($id, $if_match)
```
...
try {
    $apiInstance->deleteCharterStatusDescriptorById($id, $if_match);
} catch (Exception $e) {
    echo 'Exception when calling CharterStatusDescriptorsApi->deleteCharterStatusDescriptorById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->deletesCharterStatusDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CharterStatusDescriptorsApi->deletesCharterStatusDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCharterStatusDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\EdFiCharterStatusDescriptor[]
```
...
try {
    $result = $apiInstance->getCharterStatusDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CharterStatusDescriptorsApi->getCharterStatusDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->getCharterStatusDescriptorsById($id, $if_none_match, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CharterStatusDescriptorsApi->getCharterStatusDescriptorsById: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getCharterStatusDescriptorsPartitions()`

```php
getCharterStatusDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\GetAbsenceEventCategoryDescriptorsPartitions200Response
```
...
try {
    $result = $apiInstance->getCharterStatusDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CharterStatusDescriptorsApi->getCharterStatusDescriptorsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->keyChangesCharterStatusDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CharterStatusDescriptorsApi->keyChangesCharterStatusDescriptors: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
postCharterStatusDescriptor($ed_fi_charter_status_descriptor)
```
...
try {
    ...
    echo 'Exception when calling CharterStatusDescriptorsApi->postCharterStatusDescriptor: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
putCharterStatusDescriptor($id, $ed_fi_charter_status_descriptor, $if_match)
```
...
try {
    $apiInstance->putCharterStatusDescriptor($id, $ed_fi_charter_status_descriptor, $if_match);
} catch (Exception $e) {
    echo 'Exception when calling CharterStatusDescriptorsApi->putCharterStatusDescriptor: ', $e->getMessage(), PHP_EOL;
}
```
