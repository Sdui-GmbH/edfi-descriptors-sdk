# Descriptors\StaffIdentificationSystemDescriptorsApi
...
```php
getStaffIdentificationSystemDescriptorsById($id, $if_none_match, $use_snapshot): \Descriptors\Model\EdFiStaffIdentificationSystemDescriptor
```
