# Descriptors\CourseAttemptResultDescriptorsApi
...
| [**getCourseAttemptResultDescriptorsPartitions()**](CourseAttemptResultDescriptorsApi.md#getCourseAttemptResultDescriptorsPartitions) | **GET** /ed-fi/courseAttemptResultDescriptors/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing. |
...
$apiInstance = new Descriptors\Api\CourseAttemptResultDescriptorsApi(
...
```php
deletesCourseAttemptResultDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Descriptors\Model\TrackedChangesEdFiCourseAttemptResultDescriptorDelete[]
```
...
[**\Descriptors\Model\TrackedChangesEdFiCourseAttemptResultDescriptorDelete[]**](../Model/TrackedChangesEdFiCourseAttemptResultDescriptorDelete.md)
...
```php
getCourseAttemptResultDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\EdFiCourseAttemptResultDescriptor[]
```
...
try {
    $result = $apiInstance->getCourseAttemptResultDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\Descriptors\Model\EdFiCourseAttemptResultDescriptor[]**](../Model/EdFiCourseAttemptResultDescriptor.md)
...
```php
getCourseAttemptResultDescriptorsById($id, $if_none_match, $use_snapshot): \Descriptors\Model\EdFiCourseAttemptResultDescriptor
```
...
## `getCourseAttemptResultDescriptorsPartitions()`

```php
getCourseAttemptResultDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\GetAbsenceEventCategoryDescriptorsPartitions200Response
```
...
try {
    $result = $apiInstance->getCourseAttemptResultDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CourseAttemptResultDescriptorsApi->getCourseAttemptResultDescriptorsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
keyChangesCourseAttemptResultDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Descriptors\Model\TrackedChangesEdFiCourseAttemptResultDescriptorKeyChange[]
```
...
[**\Descriptors\Model\TrackedChangesEdFiCourseAttemptResultDescriptorKeyChange[]**](../Model/TrackedChangesEdFiCourseAttemptResultDescriptorKeyChange.md)
...
$ed_fi_course_attempt_result_descriptor = new \Descriptors\Model\EdFiCourseAttemptResultDescriptor(); // \Descriptors\Model\EdFiCourseAttemptResultDescriptor | The JSON representation of the \"courseAttemptResultDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_course_attempt_result_descriptor** | [**\Descriptors\Model\EdFiCourseAttemptResultDescriptor**](../Model/EdFiCourseAttemptResultDescriptor.md)| The JSON representation of the \&quot;courseAttemptResultDescriptor\&quot; resource to be created or updated. | |
