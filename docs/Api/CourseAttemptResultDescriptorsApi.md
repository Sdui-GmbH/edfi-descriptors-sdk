...
```php
getCourseAttemptResultDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $course_attempt_result_descriptor_id, $use_snapshot): \Descriptors\Model\EdFiCourseAttemptResultDescriptor[]
```
