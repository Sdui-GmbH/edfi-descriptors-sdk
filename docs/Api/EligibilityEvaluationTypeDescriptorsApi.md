...
```php
getEligibilityEvaluationTypeDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $eligibility_evaluation_type_descriptor_id, $use_snapshot): \Descriptors\Model\EdFiEligibilityEvaluationTypeDescriptor[]
```
