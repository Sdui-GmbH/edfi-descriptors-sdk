# OpenAPI\Client\DisciplineIncidentParticipationCodeDescriptorsApi
...
$apiInstance = new OpenAPI\Client\Api\DisciplineIncidentParticipationCodeDescriptorsApi(
...
```php
deletesDisciplineIncidentParticipationCodeDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorDelete[]**](../Model/TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorDelete.md)
...
```php
getDisciplineIncidentParticipationCodeDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $discipline_incident_participation_code_descriptor_id, $use_snapshot): \OpenAPI\Client\Model\EdFiDisciplineIncidentParticipationCodeDescriptor[]
```
...
[**\OpenAPI\Client\Model\EdFiDisciplineIncidentParticipationCodeDescriptor[]**](../Model/EdFiDisciplineIncidentParticipationCodeDescriptor.md)
...
```php
getDisciplineIncidentParticipationCodeDescriptorsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiDisciplineIncidentParticipationCodeDescriptor
```
...
```php
keyChangesDisciplineIncidentParticipationCodeDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorKeyChange[]**](../Model/TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorKeyChange.md)
...
$ed_fi_discipline_incident_participation_code_descriptor = new \OpenAPI\Client\Model\EdFiDisciplineIncidentParticipationCodeDescriptor(); // \OpenAPI\Client\Model\EdFiDisciplineIncidentParticipationCodeDescriptor | The JSON representation of the \"disciplineIncidentParticipationCodeDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_discipline_incident_participation_code_descriptor** | [**\OpenAPI\Client\Model\EdFiDisciplineIncidentParticipationCodeDescriptor**](../Model/EdFiDisciplineIncidentParticipationCodeDescriptor.md)| The JSON representation of the \&quot;disciplineIncidentParticipationCodeDescriptor\&quot; resource to be created or updated. | |
