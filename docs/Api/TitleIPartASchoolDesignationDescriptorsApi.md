...
```php
getTitleIPartASchoolDesignationDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $title_i_part_a_school_designation_descriptor_id, $use_snapshot): \Descriptors\Model\EdFiTitleIPartASchoolDesignationDescriptor[]
```
