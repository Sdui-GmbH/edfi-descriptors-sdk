# Descriptors\TitleIPartASchoolDesignationDescriptorsApi
...
| [**getTitleIPartASchoolDesignationDescriptorsPartitions()**](TitleIPartASchoolDesignationDescriptorsApi.md#getTitleIPartASchoolDesignationDescriptorsPartitions) | **GET** /ed-fi/titleIPartASchoolDesignationDescriptors/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing. |
...
$apiInstance = new Descriptors\Api\TitleIPartASchoolDesignationDescriptorsApi(
...
```php
deletesTitleIPartASchoolDesignationDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Descriptors\Model\TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorDelete[]
```
...
[**\Descriptors\Model\TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorDelete[]**](../Model/TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorDelete.md)
...
```php
getTitleIPartASchoolDesignationDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\EdFiTitleIPartASchoolDesignationDescriptor[]
```
...
try {
    $result = $apiInstance->getTitleIPartASchoolDesignationDescriptors($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\Descriptors\Model\EdFiTitleIPartASchoolDesignationDescriptor[]**](../Model/EdFiTitleIPartASchoolDesignationDescriptor.md)
...
```php
getTitleIPartASchoolDesignationDescriptorsById($id, $if_none_match, $use_snapshot): \Descriptors\Model\EdFiTitleIPartASchoolDesignationDescriptor
```
...
```php
getTitleIPartASchoolDesignationDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot): \Descriptors\Model\GetAbsenceEventCategoryDescriptorsPartitions200Response
```
...
try {
    $result = $apiInstance->getTitleIPartASchoolDesignationDescriptorsPartitions($number, $min_change_version, $max_change_version, $code_value, $description, $effective_begin_date, $effective_end_date, $id, $namespace, $short_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TitleIPartASchoolDesignationDescriptorsApi->getTitleIPartASchoolDesignationDescriptorsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
keyChangesTitleIPartASchoolDesignationDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Descriptors\Model\TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorKeyChange[]
```
...
[**\Descriptors\Model\TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorKeyChange[]**](../Model/TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorKeyChange.md)
...
$ed_fi_title_i_part_a_school_designation_descriptor = new \Descriptors\Model\EdFiTitleIPartASchoolDesignationDescriptor(); // \Descriptors\Model\EdFiTitleIPartASchoolDesignationDescriptor | The JSON representation of the \"titleIPartASchoolDesignationDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_title_i_part_a_school_designation_descriptor** | [**\Descriptors\Model\EdFiTitleIPartASchoolDesignationDescriptor**](../Model/EdFiTitleIPartASchoolDesignationDescriptor.md)| The JSON representation of the \&quot;titleIPartASchoolDesignationDescriptor\&quot; resource to be created or updated. | |
