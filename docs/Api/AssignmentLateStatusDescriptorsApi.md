# OpenAPI\Client\AssignmentLateStatusDescriptorsApi
...
$apiInstance = new OpenAPI\Client\Api\AssignmentLateStatusDescriptorsApi(
...
```php
deletesAssignmentLateStatusDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiAssignmentLateStatusDescriptorDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiAssignmentLateStatusDescriptorDelete[]**](../Model/TrackedChangesEdFiAssignmentLateStatusDescriptorDelete.md)
...
```php
getAssignmentLateStatusDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $assignment_late_status_descriptor_id, $use_snapshot): \OpenAPI\Client\Model\EdFiAssignmentLateStatusDescriptor[]
```
...
[**\OpenAPI\Client\Model\EdFiAssignmentLateStatusDescriptor[]**](../Model/EdFiAssignmentLateStatusDescriptor.md)
...
```php
getAssignmentLateStatusDescriptorsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiAssignmentLateStatusDescriptor
```
...
```php
keyChangesAssignmentLateStatusDescriptors($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiAssignmentLateStatusDescriptorKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiAssignmentLateStatusDescriptorKeyChange[]**](../Model/TrackedChangesEdFiAssignmentLateStatusDescriptorKeyChange.md)
...
$ed_fi_assignment_late_status_descriptor = new \OpenAPI\Client\Model\EdFiAssignmentLateStatusDescriptor(); // \OpenAPI\Client\Model\EdFiAssignmentLateStatusDescriptor | The JSON representation of the \"assignmentLateStatusDescriptor\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_assignment_late_status_descriptor** | [**\OpenAPI\Client\Model\EdFiAssignmentLateStatusDescriptor**](../Model/EdFiAssignmentLateStatusDescriptor.md)| The JSON representation of the \&quot;assignmentLateStatusDescriptor\&quot; resource to be created or updated. | |
