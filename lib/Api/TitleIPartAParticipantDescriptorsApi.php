...
class TitleIPartAParticipantDescriptorsApi
{
    ...
    public function deletesTitleIPartAParticipantDescriptorsWithHttpInfo($offset = null, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false, string $contentType = self::contentTypes['deletesTitleIPartAParticipantDescriptors'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Descriptors\Model\TrackedChangesEdFiTitleIPartAParticipantDescriptorDelete[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Descriptors\Model\TrackedChangesEdFiTitleIPartAParticipantDescriptorDelete[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Descriptors\Model\TrackedChangesEdFiTitleIPartAParticipantDescriptorDelete[]', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Descriptors\Model\TrackedChangesEdFiTitleIPartAParticipantDescriptorDelete[]',
    ...
    public function getTitleIPartAParticipantDescriptorsWithHttpInfo($offset = null, $limit = 25, $page_token = null, $page_size = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $code_value = null, $description = null, $effective_begin_date = null, $effective_end_date = null, $id = null, $namespace = null, $short_description = null, $use_snapshot = false, string $contentType = self::contentTypes['getTitleIPartAParticipantDescriptors'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Descriptors\Model\EdFiTitleIPartAParticipantDescriptor[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Descriptors\Model\EdFiTitleIPartAParticipantDescriptor[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Descriptors\Model\EdFiTitleIPartAParticipantDescriptor[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Descriptors\Model\EdFiTitleIPartAParticipantDescriptor[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function keyChangesTitleIPartAParticipantDescriptorsWithHttpInfo($offset = null, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false, string $contentType = self::contentTypes['keyChangesTitleIPartAParticipantDescriptors'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Descriptors\Model\TrackedChangesEdFiTitleIPartAParticipantDescriptorKeyChange[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Descriptors\Model\TrackedChangesEdFiTitleIPartAParticipantDescriptorKeyChange[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Descriptors\Model\TrackedChangesEdFiTitleIPartAParticipantDescriptorKeyChange[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Descriptors\Model\TrackedChangesEdFiTitleIPartAParticipantDescriptorKeyChange[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Descriptors\Model\EdFiTitleIPartAParticipantDescriptor $ed_fi_title_i_part_a_participant_descriptor The JSON representation of the \&quot;titleIPartAParticipantDescriptor\&quot; resource to be created or updated. (required)
