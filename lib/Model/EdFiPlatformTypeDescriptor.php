...
/**
 * EdFiPlatformTypeDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiPlatformTypeDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_platformTypeDescriptor';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'platform_type_descriptor_id' => 'int',
        'code_value' => 'string',
        'description' => 'string',
    ...
    protected static $openAPIFormats = [
        'id' => null,
        'platform_type_descriptor_id' => 'int32',
        'code_value' => null,
        'description' => null,
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'platform_type_descriptor_id' => false,
        'code_value' => false,
        'description' => true,
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'platform_type_descriptor_id' => 'platformTypeDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'platform_type_descriptor_id' => 'setPlatformTypeDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'platform_type_descriptor_id' => 'getPlatformTypeDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('platform_type_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets platform_type_descriptor_id
     *
     * @return int|null
     */
    public function getPlatformTypeDescriptorId()
    {
        return $this->container['platform_type_descriptor_id'];
    }

    /**
     * Sets platform_type_descriptor_id
     *
     * @param int|null $platform_type_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setPlatformTypeDescriptorId($platform_type_descriptor_id)
    {
        if (is_null($platform_type_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable platform_type_descriptor_id cannot be null');
        }
        $this->container['platform_type_descriptor_id'] = $platform_type_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiPlatformTypeDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiPlatformTypeDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiPlatformTypeDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiPlatformTypeDescriptor., must be smaller than or equal to 75.');
        }
