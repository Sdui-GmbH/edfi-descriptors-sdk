...
/**
 * EdFiMonitoredDescriptor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiMonitoredDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_monitoredDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'monitored_descriptor_id' => 'monitoredDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'monitored_descriptor_id' => 'setMonitoredDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'monitored_descriptor_id' => 'getMonitoredDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('monitored_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets monitored_descriptor_id
     *
     * @return int|null
     */
    public function getMonitoredDescriptorId()
    {
        return $this->container['monitored_descriptor_id'];
    }

    /**
     * Sets monitored_descriptor_id
     *
     * @param int|null $monitored_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setMonitoredDescriptorId($monitored_descriptor_id)
    {
        if (is_null($monitored_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable monitored_descriptor_id cannot be null');
        }
        $this->container['monitored_descriptor_id'] = $monitored_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiMonitoredDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiMonitoredDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiMonitoredDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiMonitoredDescriptor., must be smaller than or equal to 75.');
        }
