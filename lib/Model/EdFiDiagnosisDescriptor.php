...
/**
 * EdFiDiagnosisDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiDiagnosisDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_diagnosisDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'diagnosis_descriptor_id' => 'diagnosisDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'diagnosis_descriptor_id' => 'setDiagnosisDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'diagnosis_descriptor_id' => 'getDiagnosisDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('diagnosis_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets diagnosis_descriptor_id
     *
     * @return int|null
     */
    public function getDiagnosisDescriptorId()
    {
        return $this->container['diagnosis_descriptor_id'];
    }

    /**
     * Sets diagnosis_descriptor_id
     *
     * @param int|null $diagnosis_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setDiagnosisDescriptorId($diagnosis_descriptor_id)
    {
        if (is_null($diagnosis_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable diagnosis_descriptor_id cannot be null');
        }
        $this->container['diagnosis_descriptor_id'] = $diagnosis_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiDiagnosisDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiDiagnosisDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiDiagnosisDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiDiagnosisDescriptor., must be smaller than or equal to 75.');
        }
