...
/**
 * EdFiRaceDescriptor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiRaceDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_raceDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'race_descriptor_id' => 'raceDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'race_descriptor_id' => 'setRaceDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'race_descriptor_id' => 'getRaceDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('race_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets race_descriptor_id
     *
     * @return int|null
     */
    public function getRaceDescriptorId()
    {
        return $this->container['race_descriptor_id'];
    }

    /**
     * Sets race_descriptor_id
     *
     * @param int|null $race_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setRaceDescriptorId($race_descriptor_id)
    {
        if (is_null($race_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable race_descriptor_id cannot be null');
        }
        $this->container['race_descriptor_id'] = $race_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiRaceDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiRaceDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiRaceDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiRaceDescriptor., must be smaller than or equal to 75.');
        }
