...
/**
 * EdFiReasonExitedDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiReasonExitedDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_reasonExitedDescriptor';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'reason_exited_descriptor_id' => 'int',
        'code_value' => 'string',
        'description' => 'string',
    ...
    protected static $openAPIFormats = [
        'id' => null,
        'reason_exited_descriptor_id' => 'int32',
        'code_value' => null,
        'description' => null,
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'reason_exited_descriptor_id' => false,
        'code_value' => false,
        'description' => true,
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'reason_exited_descriptor_id' => 'reasonExitedDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'reason_exited_descriptor_id' => 'setReasonExitedDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'reason_exited_descriptor_id' => 'getReasonExitedDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('reason_exited_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets reason_exited_descriptor_id
     *
     * @return int|null
     */
    public function getReasonExitedDescriptorId()
    {
        return $this->container['reason_exited_descriptor_id'];
    }

    /**
     * Sets reason_exited_descriptor_id
     *
     * @param int|null $reason_exited_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setReasonExitedDescriptorId($reason_exited_descriptor_id)
    {
        if (is_null($reason_exited_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable reason_exited_descriptor_id cannot be null');
        }
        $this->container['reason_exited_descriptor_id'] = $reason_exited_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiReasonExitedDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiReasonExitedDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiReasonExitedDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiReasonExitedDescriptor., must be smaller than or equal to 75.');
        }
