...
/**
 * EdFiDisabilityDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiDisabilityDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_disabilityDescriptor';
    ...
    protected static $openAPIFormats = [
        'id' => null,
        'disability_descriptor_id' => 'int32',
        'code_value' => null,
        'description' => null,
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'disability_descriptor_id' => false,
        'code_value' => false,
        'description' => true,
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'disability_descriptor_id' => 'disabilityDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'disability_descriptor_id' => 'setDisabilityDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'disability_descriptor_id' => 'getDisabilityDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('disability_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets disability_descriptor_id
     *
     * @return int|null
     */
    public function getDisabilityDescriptorId()
    {
        return $this->container['disability_descriptor_id'];
    }

    /**
     * Sets disability_descriptor_id
     *
     * @param int|null $disability_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setDisabilityDescriptorId($disability_descriptor_id)
    {
        if (is_null($disability_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable disability_descriptor_id cannot be null');
        }
        $this->container['disability_descriptor_id'] = $disability_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiDisabilityDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiDisabilityDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiDisabilityDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiDisabilityDescriptor., must be smaller than or equal to 75.');
        }
