...
/**
 * EdFiCohortTypeDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiCohortTypeDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_cohortTypeDescriptor';
    ...
    protected static $openAPIFormats = [
        'id' => null,
        'cohort_type_descriptor_id' => 'int32',
        'code_value' => null,
        'description' => null,
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'cohort_type_descriptor_id' => false,
        'code_value' => false,
        'description' => true,
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'cohort_type_descriptor_id' => 'cohortTypeDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'cohort_type_descriptor_id' => 'setCohortTypeDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'cohort_type_descriptor_id' => 'getCohortTypeDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cohort_type_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets cohort_type_descriptor_id
     *
     * @return int|null
     */
    public function getCohortTypeDescriptorId()
    {
        return $this->container['cohort_type_descriptor_id'];
    }

    /**
     * Sets cohort_type_descriptor_id
     *
     * @param int|null $cohort_type_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setCohortTypeDescriptorId($cohort_type_descriptor_id)
    {
        if (is_null($cohort_type_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable cohort_type_descriptor_id cannot be null');
        }
        $this->container['cohort_type_descriptor_id'] = $cohort_type_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiCohortTypeDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiCohortTypeDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiCohortTypeDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiCohortTypeDescriptor., must be smaller than or equal to 75.');
        }
