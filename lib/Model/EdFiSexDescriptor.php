...
/**
 * EdFiSexDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiSexDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_sexDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'sex_descriptor_id' => 'sexDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'sex_descriptor_id' => 'setSexDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'sex_descriptor_id' => 'getSexDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sex_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets sex_descriptor_id
     *
     * @return int|null
     */
    public function getSexDescriptorId()
    {
        return $this->container['sex_descriptor_id'];
    }

    /**
     * Sets sex_descriptor_id
     *
     * @param int|null $sex_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setSexDescriptorId($sex_descriptor_id)
    {
        if (is_null($sex_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable sex_descriptor_id cannot be null');
        }
        $this->container['sex_descriptor_id'] = $sex_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiSexDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiSexDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiSexDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiSexDescriptor., must be smaller than or equal to 75.');
        }
