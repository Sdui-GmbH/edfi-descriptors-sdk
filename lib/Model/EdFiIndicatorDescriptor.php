...
/**
 * EdFiIndicatorDescriptor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiIndicatorDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_indicatorDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'indicator_descriptor_id' => 'indicatorDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'indicator_descriptor_id' => 'setIndicatorDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'indicator_descriptor_id' => 'getIndicatorDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('indicator_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets indicator_descriptor_id
     *
     * @return int|null
     */
    public function getIndicatorDescriptorId()
    {
        return $this->container['indicator_descriptor_id'];
    }

    /**
     * Sets indicator_descriptor_id
     *
     * @param int|null $indicator_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setIndicatorDescriptorId($indicator_descriptor_id)
    {
        if (is_null($indicator_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable indicator_descriptor_id cannot be null');
        }
        $this->container['indicator_descriptor_id'] = $indicator_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiIndicatorDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiIndicatorDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiIndicatorDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiIndicatorDescriptor., must be smaller than or equal to 75.');
        }
