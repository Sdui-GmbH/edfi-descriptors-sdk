...
/**
 * EdFiGradeTypeDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiGradeTypeDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_gradeTypeDescriptor';
    ...
    protected static $openAPIFormats = [
        'id' => null,
        'grade_type_descriptor_id' => 'int32',
        'code_value' => null,
        'description' => null,
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'grade_type_descriptor_id' => false,
        'code_value' => false,
        'description' => true,
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'grade_type_descriptor_id' => 'gradeTypeDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'grade_type_descriptor_id' => 'setGradeTypeDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'grade_type_descriptor_id' => 'getGradeTypeDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('grade_type_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets grade_type_descriptor_id
     *
     * @return int|null
     */
    public function getGradeTypeDescriptorId()
    {
        return $this->container['grade_type_descriptor_id'];
    }

    /**
     * Sets grade_type_descriptor_id
     *
     * @param int|null $grade_type_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setGradeTypeDescriptorId($grade_type_descriptor_id)
    {
        if (is_null($grade_type_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable grade_type_descriptor_id cannot be null');
        }
        $this->container['grade_type_descriptor_id'] = $grade_type_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiGradeTypeDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiGradeTypeDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiGradeTypeDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiGradeTypeDescriptor., must be smaller than or equal to 75.');
        }
