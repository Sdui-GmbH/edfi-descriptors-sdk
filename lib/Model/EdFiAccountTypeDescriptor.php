...
/**
 * EdFiAccountTypeDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiAccountTypeDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_accountTypeDescriptor';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'account_type_descriptor_id' => 'int',
        'code_value' => 'string',
        'description' => 'string',
    ...
    protected static $openAPIFormats = [
        'id' => null,
        'account_type_descriptor_id' => 'int32',
        'code_value' => null,
        'description' => null,
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'account_type_descriptor_id' => false,
        'code_value' => false,
        'description' => true,
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'account_type_descriptor_id' => 'accountTypeDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'account_type_descriptor_id' => 'setAccountTypeDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'account_type_descriptor_id' => 'getAccountTypeDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('account_type_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets account_type_descriptor_id
     *
     * @return int|null
     */
    public function getAccountTypeDescriptorId()
    {
        return $this->container['account_type_descriptor_id'];
    }

    /**
     * Sets account_type_descriptor_id
     *
     * @param int|null $account_type_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setAccountTypeDescriptorId($account_type_descriptor_id)
    {
        if (is_null($account_type_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable account_type_descriptor_id cannot be null');
        }
        $this->container['account_type_descriptor_id'] = $account_type_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiAccountTypeDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiAccountTypeDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiAccountTypeDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiAccountTypeDescriptor., must be smaller than or equal to 75.');
        }
