...
/**
 * EdFiCompetencyLevelDescriptor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiCompetencyLevelDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_competencyLevelDescriptor';
    ...
    protected static $openAPIFormats = [
        'id' => null,
        'competency_level_descriptor_id' => 'int32',
        'code_value' => null,
        'description' => null,
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'competency_level_descriptor_id' => false,
        'code_value' => false,
        'description' => true,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('competency_level_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['competency_level_descriptor_id'];
    }

    /**
     * Sets competency_level_descriptor_id
     *
     * @param int|null $competency_level_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setCompetencyLevelDescriptorId($competency_level_descriptor_id)
    {
        if (is_null($competency_level_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable competency_level_descriptor_id cannot be null');
        }
        $this->container['competency_level_descriptor_id'] = $competency_level_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiCompetencyLevelDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiCompetencyLevelDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiCompetencyLevelDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiCompetencyLevelDescriptor., must be smaller than or equal to 75.');
        }
