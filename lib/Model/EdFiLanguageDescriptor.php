...
/**
 * EdFiLanguageDescriptor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiLanguageDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_languageDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'language_descriptor_id' => 'languageDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'language_descriptor_id' => 'setLanguageDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'language_descriptor_id' => 'getLanguageDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('language_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets language_descriptor_id
     *
     * @return int|null
     */
    public function getLanguageDescriptorId()
    {
        return $this->container['language_descriptor_id'];
    }

    /**
     * Sets language_descriptor_id
     *
     * @param int|null $language_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setLanguageDescriptorId($language_descriptor_id)
    {
        if (is_null($language_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable language_descriptor_id cannot be null');
        }
        $this->container['language_descriptor_id'] = $language_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiLanguageDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiLanguageDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiLanguageDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiLanguageDescriptor., must be smaller than or equal to 75.');
        }
