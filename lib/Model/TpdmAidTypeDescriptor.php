...
/**
 * TpdmAidTypeDescriptor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TpdmAidTypeDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tpdm_aidTypeDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'aid_type_descriptor_id' => 'aidTypeDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'aid_type_descriptor_id' => 'setAidTypeDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'aid_type_descriptor_id' => 'getAidTypeDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('aid_type_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets aid_type_descriptor_id
     *
     * @return int|null
     */
    public function getAidTypeDescriptorId()
    {
        return $this->container['aid_type_descriptor_id'];
    }

    /**
     * Sets aid_type_descriptor_id
     *
     * @param int|null $aid_type_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setAidTypeDescriptorId($aid_type_descriptor_id)
    {
        if (is_null($aid_type_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable aid_type_descriptor_id cannot be null');
        }
        $this->container['aid_type_descriptor_id'] = $aid_type_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling TpdmAidTypeDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TpdmAidTypeDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TpdmAidTypeDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling TpdmAidTypeDescriptor., must be smaller than or equal to 75.');
        }
