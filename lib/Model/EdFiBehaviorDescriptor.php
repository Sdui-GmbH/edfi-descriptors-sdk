...
/**
 * EdFiBehaviorDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiBehaviorDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_behaviorDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'behavior_descriptor_id' => 'behaviorDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'behavior_descriptor_id' => 'setBehaviorDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'behavior_descriptor_id' => 'getBehaviorDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('behavior_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets behavior_descriptor_id
     *
     * @return int|null
     */
    public function getBehaviorDescriptorId()
    {
        return $this->container['behavior_descriptor_id'];
    }

    /**
     * Sets behavior_descriptor_id
     *
     * @param int|null $behavior_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setBehaviorDescriptorId($behavior_descriptor_id)
    {
        if (is_null($behavior_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable behavior_descriptor_id cannot be null');
        }
        $this->container['behavior_descriptor_id'] = $behavior_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiBehaviorDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiBehaviorDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiBehaviorDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiBehaviorDescriptor., must be smaller than or equal to 75.');
        }
