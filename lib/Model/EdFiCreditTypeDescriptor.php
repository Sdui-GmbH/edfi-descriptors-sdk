...
/**
 * EdFiCreditTypeDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiCreditTypeDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_creditTypeDescriptor';
    ...
    protected static $openAPIFormats = [
        'id' => null,
        'credit_type_descriptor_id' => 'int32',
        'code_value' => null,
        'description' => null,
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'credit_type_descriptor_id' => false,
        'code_value' => false,
        'description' => true,
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'credit_type_descriptor_id' => 'creditTypeDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'credit_type_descriptor_id' => 'setCreditTypeDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'credit_type_descriptor_id' => 'getCreditTypeDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('credit_type_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets credit_type_descriptor_id
     *
     * @return int|null
     */
    public function getCreditTypeDescriptorId()
    {
        return $this->container['credit_type_descriptor_id'];
    }

    /**
     * Sets credit_type_descriptor_id
     *
     * @param int|null $credit_type_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setCreditTypeDescriptorId($credit_type_descriptor_id)
    {
        if (is_null($credit_type_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable credit_type_descriptor_id cannot be null');
        }
        $this->container['credit_type_descriptor_id'] = $credit_type_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiCreditTypeDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiCreditTypeDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiCreditTypeDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiCreditTypeDescriptor., must be smaller than or equal to 75.');
        }
