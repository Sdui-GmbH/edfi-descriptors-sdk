...
/**
 * EdFiCostRateDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiCostRateDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_costRateDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'cost_rate_descriptor_id' => 'costRateDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'cost_rate_descriptor_id' => 'setCostRateDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'cost_rate_descriptor_id' => 'getCostRateDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cost_rate_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets cost_rate_descriptor_id
     *
     * @return int|null
     */
    public function getCostRateDescriptorId()
    {
        return $this->container['cost_rate_descriptor_id'];
    }

    /**
     * Sets cost_rate_descriptor_id
     *
     * @param int|null $cost_rate_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setCostRateDescriptorId($cost_rate_descriptor_id)
    {
        if (is_null($cost_rate_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable cost_rate_descriptor_id cannot be null');
        }
        $this->container['cost_rate_descriptor_id'] = $cost_rate_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiCostRateDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiCostRateDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiCostRateDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiCostRateDescriptor., must be smaller than or equal to 75.');
        }
