...
/**
 * EdFiRelationDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiRelationDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_relationDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'relation_descriptor_id' => 'relationDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'relation_descriptor_id' => 'setRelationDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'relation_descriptor_id' => 'getRelationDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('relation_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets relation_descriptor_id
     *
     * @return int|null
     */
    public function getRelationDescriptorId()
    {
        return $this->container['relation_descriptor_id'];
    }

    /**
     * Sets relation_descriptor_id
     *
     * @param int|null $relation_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setRelationDescriptorId($relation_descriptor_id)
    {
        if (is_null($relation_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable relation_descriptor_id cannot be null');
        }
        $this->container['relation_descriptor_id'] = $relation_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiRelationDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiRelationDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiRelationDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiRelationDescriptor., must be smaller than or equal to 75.');
        }
