...
/**
 * EdFiEntryTypeDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiEntryTypeDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_entryTypeDescriptor';
    ...
    protected static $openAPIFormats = [
        'id' => null,
        'entry_type_descriptor_id' => 'int32',
        'code_value' => null,
        'description' => null,
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'entry_type_descriptor_id' => false,
        'code_value' => false,
        'description' => true,
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'entry_type_descriptor_id' => 'entryTypeDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'entry_type_descriptor_id' => 'setEntryTypeDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'entry_type_descriptor_id' => 'getEntryTypeDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('entry_type_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets entry_type_descriptor_id
     *
     * @return int|null
     */
    public function getEntryTypeDescriptorId()
    {
        return $this->container['entry_type_descriptor_id'];
    }

    /**
     * Sets entry_type_descriptor_id
     *
     * @param int|null $entry_type_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setEntryTypeDescriptorId($entry_type_descriptor_id)
    {
        if (is_null($entry_type_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable entry_type_descriptor_id cannot be null');
        }
        $this->container['entry_type_descriptor_id'] = $entry_type_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiEntryTypeDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiEntryTypeDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiEntryTypeDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiEntryTypeDescriptor., must be smaller than or equal to 75.');
        }
