...
/**
 * EdFiProgressDescriptor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiProgressDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_progressDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'progress_descriptor_id' => 'progressDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'progress_descriptor_id' => 'setProgressDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'progress_descriptor_id' => 'getProgressDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('progress_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets progress_descriptor_id
     *
     * @return int|null
     */
    public function getProgressDescriptorId()
    {
        return $this->container['progress_descriptor_id'];
    }

    /**
     * Sets progress_descriptor_id
     *
     * @param int|null $progress_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setProgressDescriptorId($progress_descriptor_id)
    {
        if (is_null($progress_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable progress_descriptor_id cannot be null');
        }
        $this->container['progress_descriptor_id'] = $progress_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiProgressDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiProgressDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiProgressDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiProgressDescriptor., must be smaller than or equal to 75.');
        }
