...
/**
 * EdFiWeaponDescriptor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiWeaponDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_weaponDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'weapon_descriptor_id' => 'weaponDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'weapon_descriptor_id' => 'setWeaponDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'weapon_descriptor_id' => 'getWeaponDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('weapon_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets weapon_descriptor_id
     *
     * @return int|null
     */
    public function getWeaponDescriptorId()
    {
        return $this->container['weapon_descriptor_id'];
    }

    /**
     * Sets weapon_descriptor_id
     *
     * @param int|null $weapon_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setWeaponDescriptorId($weapon_descriptor_id)
    {
        if (is_null($weapon_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable weapon_descriptor_id cannot be null');
        }
        $this->container['weapon_descriptor_id'] = $weapon_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiWeaponDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiWeaponDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiWeaponDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiWeaponDescriptor., must be smaller than or equal to 75.');
        }
