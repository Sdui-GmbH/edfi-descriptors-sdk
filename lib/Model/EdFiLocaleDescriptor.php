...
/**
 * EdFiLocaleDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiLocaleDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_localeDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'locale_descriptor_id' => 'localeDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'locale_descriptor_id' => 'setLocaleDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'locale_descriptor_id' => 'getLocaleDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('locale_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets locale_descriptor_id
     *
     * @return int|null
     */
    public function getLocaleDescriptorId()
    {
        return $this->container['locale_descriptor_id'];
    }

    /**
     * Sets locale_descriptor_id
     *
     * @param int|null $locale_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setLocaleDescriptorId($locale_descriptor_id)
    {
        if (is_null($locale_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable locale_descriptor_id cannot be null');
        }
        $this->container['locale_descriptor_id'] = $locale_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiLocaleDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiLocaleDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiLocaleDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiLocaleDescriptor., must be smaller than or equal to 75.');
        }
