...
/**
 * EdFiTermDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiTermDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_termDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'term_descriptor_id' => 'termDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'term_descriptor_id' => 'setTermDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'term_descriptor_id' => 'getTermDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('term_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets term_descriptor_id
     *
     * @return int|null
     */
    public function getTermDescriptorId()
    {
        return $this->container['term_descriptor_id'];
    }

    /**
     * Sets term_descriptor_id
     *
     * @param int|null $term_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setTermDescriptorId($term_descriptor_id)
    {
        if (is_null($term_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable term_descriptor_id cannot be null');
        }
        $this->container['term_descriptor_id'] = $term_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiTermDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiTermDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiTermDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiTermDescriptor., must be smaller than or equal to 75.');
        }
