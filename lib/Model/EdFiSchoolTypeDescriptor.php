...
/**
 * EdFiSchoolTypeDescriptor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiSchoolTypeDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_schoolTypeDescriptor';
    ...
    protected static $openAPIFormats = [
        'id' => null,
        'school_type_descriptor_id' => 'int32',
        'code_value' => null,
        'description' => null,
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'school_type_descriptor_id' => false,
        'code_value' => false,
        'description' => true,
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'school_type_descriptor_id' => 'schoolTypeDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'school_type_descriptor_id' => 'setSchoolTypeDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'school_type_descriptor_id' => 'getSchoolTypeDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('school_type_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets school_type_descriptor_id
     *
     * @return int|null
     */
    public function getSchoolTypeDescriptorId()
    {
        return $this->container['school_type_descriptor_id'];
    }

    /**
     * Sets school_type_descriptor_id
     *
     * @param int|null $school_type_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setSchoolTypeDescriptorId($school_type_descriptor_id)
    {
        if (is_null($school_type_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable school_type_descriptor_id cannot be null');
        }
        $this->container['school_type_descriptor_id'] = $school_type_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiSchoolTypeDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiSchoolTypeDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiSchoolTypeDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiSchoolTypeDescriptor., must be smaller than or equal to 75.');
        }
