...
/**
 * EdFiIdeaPartDescriptor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiIdeaPartDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_ideaPartDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'idea_part_descriptor_id' => 'ideaPartDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'idea_part_descriptor_id' => 'setIdeaPartDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'idea_part_descriptor_id' => 'getIdeaPartDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('idea_part_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets idea_part_descriptor_id
     *
     * @return int|null
     */
    public function getIdeaPartDescriptorId()
    {
        return $this->container['idea_part_descriptor_id'];
    }

    /**
     * Sets idea_part_descriptor_id
     *
     * @param int|null $idea_part_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setIdeaPartDescriptorId($idea_part_descriptor_id)
    {
        if (is_null($idea_part_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable idea_part_descriptor_id cannot be null');
        }
        $this->container['idea_part_descriptor_id'] = $idea_part_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiIdeaPartDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiIdeaPartDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiIdeaPartDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiIdeaPartDescriptor., must be smaller than or equal to 75.');
        }
