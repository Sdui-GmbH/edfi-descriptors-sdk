...
/**
 * EdFiSectionTypeDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiSectionTypeDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_sectionTypeDescriptor';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'section_type_descriptor_id' => 'int',
        'code_value' => 'string',
        'description' => 'string',
    ...
    protected static $openAPIFormats = [
        'id' => null,
        'section_type_descriptor_id' => 'int32',
        'code_value' => null,
        'description' => null,
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'section_type_descriptor_id' => false,
        'code_value' => false,
        'description' => true,
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'section_type_descriptor_id' => 'sectionTypeDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'section_type_descriptor_id' => 'setSectionTypeDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'section_type_descriptor_id' => 'getSectionTypeDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('section_type_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets section_type_descriptor_id
     *
     * @return int|null
     */
    public function getSectionTypeDescriptorId()
    {
        return $this->container['section_type_descriptor_id'];
    }

    /**
     * Sets section_type_descriptor_id
     *
     * @param int|null $section_type_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setSectionTypeDescriptorId($section_type_descriptor_id)
    {
        if (is_null($section_type_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable section_type_descriptor_id cannot be null');
        }
        $this->container['section_type_descriptor_id'] = $section_type_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiSectionTypeDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiSectionTypeDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiSectionTypeDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiSectionTypeDescriptor., must be smaller than or equal to 75.');
        }
