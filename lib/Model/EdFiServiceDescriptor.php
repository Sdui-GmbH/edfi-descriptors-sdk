...
/**
 * EdFiServiceDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Descriptors
 * @author   OpenAPI Generator team
 ...
 */
class EdFiServiceDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_serviceDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'service_descriptor_id' => 'serviceDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'service_descriptor_id' => 'setServiceDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'service_descriptor_id' => 'getServiceDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('service_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets service_descriptor_id
     *
     * @return int|null
     */
    public function getServiceDescriptorId()
    {
        return $this->container['service_descriptor_id'];
    }

    /**
     * Sets service_descriptor_id
     *
     * @param int|null $service_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setServiceDescriptorId($service_descriptor_id)
    {
        if (is_null($service_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable service_descriptor_id cannot be null');
        }
        $this->container['service_descriptor_id'] = $service_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiServiceDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiServiceDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiServiceDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiServiceDescriptor., must be smaller than or equal to 75.');
        }
