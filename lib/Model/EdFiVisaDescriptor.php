...
/**
 * EdFiVisaDescriptor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiVisaDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_visaDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'visa_descriptor_id' => 'visaDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'visa_descriptor_id' => 'setVisaDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'visa_descriptor_id' => 'getVisaDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('visa_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets visa_descriptor_id
     *
     * @return int|null
     */
    public function getVisaDescriptorId()
    {
        return $this->container['visa_descriptor_id'];
    }

    /**
     * Sets visa_descriptor_id
     *
     * @param int|null $visa_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setVisaDescriptorId($visa_descriptor_id)
    {
        if (is_null($visa_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable visa_descriptor_id cannot be null');
        }
        $this->container['visa_descriptor_id'] = $visa_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling EdFiVisaDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EdFiVisaDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiVisaDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling EdFiVisaDescriptor., must be smaller than or equal to 75.');
        }
