...
/**
 * TpdmGenderDescriptor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TpdmGenderDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tpdm_genderDescriptor';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'gender_descriptor_id' => 'genderDescriptorId',
    ...
    protected static $setters = [
        'id' => 'setId',
        'gender_descriptor_id' => 'setGenderDescriptorId',
    ...
    protected static $getters = [
        'id' => 'getId',
        'gender_descriptor_id' => 'getGenderDescriptorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('gender_descriptor_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets gender_descriptor_id
     *
     * @return int|null
     */
    public function getGenderDescriptorId()
    {
        return $this->container['gender_descriptor_id'];
    }

    /**
     * Sets gender_descriptor_id
     *
     * @param int|null $gender_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     *
     * @return self
     */
    public function setGenderDescriptorId($gender_descriptor_id)
    {
        if (is_null($gender_descriptor_id)) {
            throw new \InvalidArgumentException('non-nullable gender_descriptor_id cannot be null');
        }
        $this->container['gender_descriptor_id'] = $gender_descriptor_id;
    ...
    public function setCodeValue($code_value)
    {
        ...
        if ((mb_strlen($code_value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code_value when calling TpdmGenderDescriptor., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TpdmGenderDescriptor., must be smaller than or equal to 1024.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TpdmGenderDescriptor., must be smaller than or equal to 255.');
        }
    ...
    public function setShortDescription($short_description)
    {
        ...
        if ((mb_strlen($short_description) > 75)) {
            throw new \InvalidArgumentException('invalid length for $short_description when calling TpdmGenderDescriptor., must be smaller than or equal to 75.');
        }
